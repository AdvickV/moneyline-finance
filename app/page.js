...
export default function Page() {
  ...
  return (
    <main className="bg-[#030712] text-[#162033] min-h-screen font-sans overflow-x-hidden">
      ...
      <section
        id="home"
        className="relative min-h-auto lg:min-h-[92vh] flex items-center bg-gradient-to-br from-[#020617] via-[#071B34] to-[#020617] text-whitepy-12 md:py-28 px-5 md:px-6 overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="bg-emerald-500 hover:bg-emerald-400 px-5 py-3 md:px-7 md:py-4 rounded-2xl font-semibold transition shadow-2xl"
              >
                Call Now
              </a>
              ...
              <a
                href="https://wa.me/919994044442"
                className="border border-white/20 bg-white/10 backdrop-blur-xl hover:bg-white/20 px-5 py-3 md:px-7 md:py-4 rounded-2xl font-semibold transition"
              >
                WhatsApp Us
              </a>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[32px] p-6 md:p-8 shadow-2xl">
            <div className="space-y-6">
              <div className="bg-white/10 rounded-3xl p-5 flex flex-col items-center justify-center min-h-[110px] md:min-h-[140px]">
            ...
            <div className="grid lg:grid-cols-2 gap-10 md:gap-16">
              <div>
                ...
                <div className="flex flex-wrap gap-4 mt-10">
                  <a
                    href="tel:+919994044442"
                    className="bg-emerald-500 hover:bg-emerald-400 px-5 py-3 md:px-7 md:py-4 rounded-2xl font-semibold transition"
                  >
                    Call Now
                  </a>
                  ...
                  <a
                    href="https://wa.me/919994044442"
                    className="bg-white/10 border border-white/10 backdrop-blur-xl hover:bg-white/20 px-5 py-3 md:px-7 md:py-4 rounded-2xl font-semibold transition"
                  >
                    WhatsApp Us
                  </a>
                </div>
